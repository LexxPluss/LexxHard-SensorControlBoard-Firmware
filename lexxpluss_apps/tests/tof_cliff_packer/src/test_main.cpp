...
ZTEST(tof_cliff_packer, test_contract_sha_pin)
{
    zassert_equal(0, strcmp(ctr::kContractSha256,
        "4b3dae652d73e6eabf17d721a90b06371effbb3aaefb3d25a2218bb860dd47f7"));
    zassert_equal(0, strcmp(ctr::kContractVersion, "commissioning-2026-08-18b"));
    ...
    zassert_equal(0, strcmp(ctr::kArtefactSetId,
        "1a0a2094e928392d29c7153f84de6951159113198714e0b734e6ebd39bf74b07"));
