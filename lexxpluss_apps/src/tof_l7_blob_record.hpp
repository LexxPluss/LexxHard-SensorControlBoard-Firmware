 ...
 * the minimal-field init/start/ready/fetch/stop path plus the port and retained configuration/xtalk
 * arrays into B6 adds another measured 7,124 B. The constant blob is therefore the first hard
 * problem, and storage_partition (131,072 B at offset 0x20000) is the one region no application
 * code referenced.
 *
